      ...
      <div className="space-y-24 mt-24">
        <div className="grid md:grid-cols-2 gap-12">
          <div className="space-y-6">
            <div className="flex items-center gap-2 h-12 w-12 rounded-full bg-orange-100 justify-center">
          ...
          <div className="space-y-4 bg-white rounded-2xl p-6 shadow-xl border border-orange-100">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="space-y-4 bg-white rounded-2xl p-6 shadow-xl border border-orange-100">
            <div className="h-40 bg-gradient-to-t from-orange-100 to bg-orange-50 rounded-lg" />
          ...
          {faqs.map((faq, index) => {
            return (
              <AccordionItem key={faq.q} value={`item-${index}`}>
                ...
                <AccordionContent className="text-orange-900">
                  {faq.a}
                </AccordionContent>
              </AccordionItem>
            );
          ...
          <CardContent className="p-12 text-center">
            ...
            <Link href="/dashboard">
              <Button size="lg" variant="journal" className="animate-bounce">
                {" "}
                Get Started for Free <ChevronRight className="h-5 w-5 ml-2" />
              </Button>
            </Link>
          </CardContent>
        </Card>
